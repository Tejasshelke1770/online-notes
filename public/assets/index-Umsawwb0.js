...
` +
    ...
    var qe = Math.clz32 ? Math.clz32 : A,
      Je = Math.log,
      k = Math.LN2;
    function A(e) {
          ...
          !n.hasOwnProperty(r) ||
            ...
            (r.indexOf(`--`) === 0
              ...
              : r === `float`
                ...
                : (e[r] = ``));
        for (var i in t)
          ((r = t[i]), t.hasOwnProperty(i) && n[i] !== r && en(e, i, r));
    ...
    var Dn = {
      ...
      M = En(Pn),
      Fn = En(h({}, Pn, { dataTransfer: 0 })),
      In = En(h({}, kn, { relatedTarget: 0 })),
      Ln = En(
      ...
      for (var i = t, o = !1; i !== null; ) {
        ...
        if (i.tag === 10) {
          ...
          if (((s = s.memoizedProps), s !== null)) {
            var c = i.type;
            Or(i.pendingProps.value, s.value) ||
              (e === null ? (e = [c]) : e.push(c));
          }
    ...
    function mc(e, t, n) {
      ...
      if (o !== null) {
        ...
        if ((uo(t), i))
          ...
          (H || ra(e, t, n, !1), (i = (n & e.childLanes) !== 0), H || i)
        ) {
          if (
            ((r = K),
          ...
          a: {
            ...
            if (
              ...
              if (
                ...
                ((i = wi(Error(a(424)), t)), Yi(i), (t = yc(e, t, r, n)));
                break a;
              } else {
      ...
      switch ((Li(t), t.tag)) {
        ...
        case 27:
          if (
            ...
            ((e = he.current),
              Ki(t) ? Wi(t, e) : ((e = ff(i, r, n)), (t.stateNode = e), Pc(t)));
          }
          return (U(t), null);
        case 5:
...
var me = pe(),
  D = me.FormData === void 0 ? void 0 : me.FormData,
  O = (e) => {
    if (!e) return !1;
  ...
  he = y(`URLSearchParams`),
  [ge, _e, ve, ye] = [`ReadableStream`, `Request`, `Response`, `Headers`].map(
    y,
  ),
  be = (e) =>
...
var Ce =
  ...
  we = (e) => !ee(e) && e !== Ce;
function Te() {
  let { caseless: e, skipUndefined: t } = (we(this) && this) || {},
    n = {},
    r = (r, i) => {
  ...
  for (let e = 0, t = arguments.length; e < t; e++)
    arguments[e] && xe(arguments[e], r);
  return n;
}
var Ee = (e, t, n, { allOwnKeys: r } = {}) => (
    xe(
      t,
      (t, r) => {
        n && w(t)
  ...
  De = (e) => (e.charCodeAt(0) === 65279 && (e = e.slice(1)), e),
  Oe = (e, t, n, r) => {
...
function We(e) {
  return !!(e && w(e.append) && e[_] === `FormData` && e[g]);
}
var Ge = (e) => {
    let t = Array(10),
      n = (e, r) => {
  ...
  Ke = y(`AsyncFunction`),
  qe = (e) => e && (ie(e) || w(e)) && w(e.then) && w(e.catch),
  Je = ((e, t) =>
    e
      ? setImmediate
      : t
...
function Qe(e) {
  return k.isArray(e) && !e.some(Ye);
}
var $e = k.toFlatObject(k, {}, null, function (e) {
...
function et(e, t, n) {
  ...
  function d(e, n, i) {
    ...
    if (k.isReactNative(t) && k.isReactNativeBlob(e))
      return (t.append(Ze(i, n, a), u(e)), !1);
    ...
    return Ye(e) ? !0 : (t.append(Ze(i, n, a), u(e)), !1);
  }
  let f = [],
    p = Object.assign($e, {
      defaultVisitor: d,
  ...
  function m(e, n, r = 0) {
    if (!k.isUndefined(e)) {
      ...
      (f.push(e),
        k.forEach(e, function (e, a) {
          (!(k.isUndefined(e) || e === null) &&
            i.call(t, e, k.isString(a) ? a.trim() : a, n, p)) === !0 &&
...
var ot = class {
  ...
  ct = {
    isBrowser: !0,
    classes: {
      URLSearchParams: typeof URLSearchParams < `u` ? URLSearchParams : nt,
  ...
  dt = (typeof navigator == `object` && navigator) || void 0,
  ft =
    ut &&
    (!dt || [`ReactNative`, `NativeScript`, `NS`].indexOf(dt.product) < 0),
  pt =
    typeof WorkerGlobalScope < `u` &&
    self instanceof WorkerGlobalScope &&
    typeof self.importScripts == `function`,
  mt = (ut && window.location.href) || `http://localhost`,
  j = { ...lt, ...ct };
function ht(e, t) {
...
function vt(e) {
  function t(e, n, r, i) {
    ...
    return (
      ...
      s
        ? (k.hasOwnProp(r, a)
            ? (r[a] = k.isArray(r[a]) ? r[a].concat(n) : [r[a], n])
            : (r[a] = n),
          !o)
        : ((!r[a] || !k.isObject(r[a])) && (r[a] = []),
          t(e, n, r[a], i) && k.isArray(r[a]) && (r[a] = _t(r[a])),
          !o)
    );
  }
...
var yt = (e, t) => (e != null && k.hasOwnProp(e, t) ? e[t] : void 0);
function bt(e, t, n) {
  if (k.isString(e))
    try {
...
var xt = {
    ...
    function (e, t) {
      ...
      if (i) {
        ...
        if (n.indexOf(`application/x-www-form-urlencoded`) > -1)
          return ht(e, t).toString();
        if ((a = k.isFileList(e)) || n.indexOf(`multipart/form-data`) > -1) {
          let n = yt(this, `env`),
            r = n && n.FormData;
          return et(a ? { "files[]": e } : e, r && new r(), t);
        }
      }
  ...
  transformResponse: [
    function (e) {
      let t = yt(this, `transitional`) || xt.transitional,
        ...
        try {
          ...
          if (n)
            throw e.name === `SyntaxError`
              ? A.from(e, A.ERR_BAD_RESPONSE, this, null, yt(this, `response`))
              : e;
        }
      }
      return e;
...
function Ot(e) {
  return Et(e.replace(Tt, ``));
}
function kt(e) {
  return e === !1 || e == null ? e : k.isArray(e) ? e.map(kt) : Ot(String(e));
}
function At(e) {
...
var Ft = class {
  ...
  set(e, t, n) {
    ...
    else if (k.isString(e) && (e = e.trim()) && !jt(e)) a(Ct(e), t);
  ...
  has(e, t) {
    if (((e = Dt(e)), e)) {
      let n = k.findKey(this, e);
      return !!(n && this[n] !== void 0 && (!t || Mt(this, this[n], n, t)));
    }
    return !1;
  }
  delete(e, t) {
    ...
    function i(e) {
      if (((e = Dt(e)), e)) {
        let i = k.findKey(n, e);
        i && (!t || Mt(n, n[i], i, t)) && (delete n[i], (r = !0));
      }
    }
  ...
  clear(e) {
    ...
    for (; n--; ) {
      let i = t[n];
      (!e || Mt(this, this[i], i, e, !0)) && (delete this[i], (r = !0));
    }
    return r;
  }
  normalize(e) {
    ...
    return (
      k.forEach(this, (r, i) => {
        ...
        let o = e ? Nt(i) : String(i).trim();
        (o !== i && delete t[i], (t[o] = kt(r)), (n[o] = !0));
      }),
      this
    );
  }
...
`);
  ...
  static accessor(e) {
    let t = (this[wt] = this[wt] = { accessors: {} }).accessors,
      n = this.prototype;
    function r(e) {
      let r = Dt(e);
      t[r] || (Pt(n, e), (t[r] = !0));
...
(Ft.accessor([
  ...
  k.reduceDescriptors(Ft.prototype, ({ value: e }, t) => {
  ...
  return (
    k.forEach(Object.keys({ ...e, ...t }), function (r) {
      ...
      let a = k.hasOwnProp(c, r) ? c[r] : i,
        o = a(
          k.hasOwnProp(e, r) ? e[r] : void 0,
          k.hasOwnProp(t, r) ? t[r] : void 0,
          r,
        );
...
var $t = (e) => {
    ...
    if (
      ...
      (t.url = at(Xt(l, d, u), e.params, e.paramsSerializer)),
      c &&
        s.set(
          `Authorization`,
          `Basic ` +
    ...
    if (
      ...
      (k.isFunction(i) && (i = i(t)), i === !0 || (i == null && Kt(t.url)))
    ) {
      let e = a && o && qt.read(o);
      e && s.set(a, e);
    }
...
((M.Axios = kn),
  ...
  (M.mergeConfig = Qt),
  (M.AxiosHeaders = Ft),
  (M.formToJSON = (e) => vt(k.isHTMLForm(e) ? new FormData(e) : e)),
...
(0, f.createRoot)(document.getElementById(`root`)).render(
  (0, In.jsx)(d.StrictMode, {
    children: (0, In.jsx)(() => {
      let [e, t] = (0, d.useState)([]),
        [n, r] = (0, d.useState)({ value: !1, id: `` }),
        [i, a] = (0, d.useState)(``),
        [o, s] = (0, d.useState)(``),
        c = async () => {
          ...
          children: [
            ...
            (0, In.jsx)(`div`, {
              ...
              children: e.length
                ? e.map((e, t) =>
                    (0, In.jsxs)(
                      `div`,
                      {
                        className: `note`,
                        children: [
                          (0, In.jsx)(`h4`, { children: e.title }),
                          (0, In.jsx)(`p`, { children: e.description }),
                          (0, In.jsxs)(`div`, {
                            className: `buttons`,
                            children: [
                              (0, In.jsx)(`button`, {
                ...
                : (0, In.jsx)(`h1`, { children: `No notes to show` }),
            }),
          ],
        })
      );
